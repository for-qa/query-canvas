# Contributing to QueryCanvas

First off, thank you for considering contributing to QueryCanvas! It's people like you that make this tool great.
...
3. Make sure the code passes the linter by running `npm run lint`.
